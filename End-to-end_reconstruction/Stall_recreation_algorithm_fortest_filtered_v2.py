...
for nr,folder_path in enumerate([news, music,sport]):
    ...
    np.save('stalls_detection_info'+str(kind)+'_filter_v2.npy',diff)
...
associations_news=np.load('stalls_detection_infonews_filter_v2.npy', allow_pickle=True)
associations_music=np.load('stalls_detection_infomusic_filter_v2.npy', allow_pickle=True)
associations_sport=np.load('stalls_detection_infosport_filter_v2.npy', allow_pickle=True)
