...
def save_cliks_and_clear(folder_path):
    global detected_clicks
    with open(folder_path + 'Detected_clicks.txt', 'a') as f_clicks:
...
def save_stalls_and_clear(folder_path):
    ...
    with open(folder_path + 'Detected_stalls.txt', 'a') as f_stalls:
...
if __name__ == "__main__":
    ...
    if os.path.exists(folder_path + 'Detected_stalls.txt'):
        os.remove(folder_path + 'Detected_stalls.txt')
    if os.path.exists(folder_path + 'Detected_clicks.txt'):
        os.remove(folder_path + 'Detected_clicks.txt')
