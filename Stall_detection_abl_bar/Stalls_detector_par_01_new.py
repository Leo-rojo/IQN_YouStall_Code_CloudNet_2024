...
if __name__ == "__main__":
    ...
    Network_id = '1000Kbps'
    Video_link = 'https://www.youtube.com/watch?v=mzdfGCdNSHQ'#'https://www.youtube.com/watch?v=lnhq0Zz6IMM'#'https://www.youtube.com/watch?v=cL710l090u0'#'https://www.youtube.com/watch?v=mzdfGCdNSHQ'#https://www.youtube.com/watch?v=cL710l090u0'#https://www.youtube.com/watch?v=Ufe-nmkZwXI'#'https://www.youtube.com/watch?v=1JQfg3GiZ1c'#'https://www.youtube.com/watch?v=mzdfGCdNSHQ'#'https://www.youtube.com/watch?v=-hK3py6FlDU'#https://www.youtube.com/watch?v=bZ3O-8pQLd0'
    ...
    folder_path = 'Results_external/' + video_id + '_' + Network_id + '/' + 'p_' + str(click_frequency)+'/'# + ' w_' + str(tw) + '/'
    ...
    while time.time() - start_time < duration:
        ...
        if current_time >= next_capture_time:
            ...
            if stall_detected and previous_stall_detected: # stall continues   TT
                ...
                if thumb != 'thumb':
                    sum_time += interval # questionable round for excess
                    if save_last_three_outcomes[-1]=='potential end of stall':
                        print('continuation of error')
                        sum_time += interval  # questionable round for excess
                        save_last_three_outcomes.append('stall continues')
                    else:
                ...
                if sum_time!=0:
                    ...
                    save_last_three_outcomes.append('potential end of stall')
                ...
                if save_last_three_outcomes and save_last_three_outcomes[-1]=='potential end of stall':
                    # routine end of stall
                    print('end of stall')
                    ...
                    save_stalls_and_clear(folder_path,click_frequency)
                else:
                    print('no stall')
                    save_last_three_outcomes.append('no stall')
