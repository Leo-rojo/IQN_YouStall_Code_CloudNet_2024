...
plt.bar(b, [1,2,3,4,5,6,7,8], color ='r', width = barWidth-0.1,linewidth=0,label='news',align='edge')
plt.bar(c, [1,2,3,4,5,6,7,8], color ='g', width = barWidth-0.1,linewidth=0,label='music',align='edge')
plt.bar(d, [1,2,3,4,5,6,7,8], color ='b', width = barWidth-0.1,linewidth=0,label='sports',align='edge')
