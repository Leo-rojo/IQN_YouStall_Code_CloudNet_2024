...
# Load CPU data
cpu2 = np.mean(np.load('input_data/CPU2.npy', allow_pickle=True))
cpu3 = np.mean(np.load('input_data/CPU3.npy', allow_pickle=True))
cpu4 = np.mean(np.load('input_data/CPU4.npy', allow_pickle=True))
cpu5 = np.mean(np.load('input_data/CPU5.npy', allow_pickle=True))
cpu6 = np.mean(np.load('input_data/CPU6.npy', allow_pickle=True))

cpu2_2 = np.mean(np.load('input_data/CPU2_2.npy', allow_pickle=True))
cpu3_2 = np.mean(np.load('input_data/CPU3_2.npy', allow_pickle=True))
cpu4_2 = np.mean(np.load('input_data/CPU4_2.npy', allow_pickle=True))
cpu5_2 = np.mean(np.load('input_data/CPU5_2.npy', allow_pickle=True))
cpu6_2 = np.mean(np.load('input_data/CPU6_2.npy', allow_pickle=True))

cpu2_3 = np.mean(np.load('input_data/CPU2_3.npy', allow_pickle=True))
cpu3_3 = np.mean(np.load('input_data/CPU3_3.npy', allow_pickle=True))
cpu4_3 = np.mean(np.load('input_data/CPU4_3.npy', allow_pickle=True))
cpu5_3 = np.mean(np.load('input_data/CPU5_3.npy', allow_pickle=True))
cpu6_3 = np.mean(np.load('input_data/CPU6_3.npy', allow_pickle=True))

cpu2_4 = np.mean(np.load('input_data/CPU2_4.npy', allow_pickle=True))
cpu3_4 = np.mean(np.load('input_data/CPU3_4.npy', allow_pickle=True))
cpu4_4 = np.mean(np.load('input_data/CPU4_4.npy', allow_pickle=True))
cpu5_4 = np.mean(np.load('input_data/CPU5_4.npy', allow_pickle=True))
cpu6_4 = np.mean(np.load('input_data/CPU6_4.npy', allow_pickle=True))

# Load Memory data
mem2 = np.mean(np.load('input_data/Memory2.npy', allow_pickle=True))
mem3 = np.mean(np.load('input_data/Memory3.npy', allow_pickle=True))
mem4 = np.mean(np.load('input_data/Memory4.npy', allow_pickle=True))
mem5 = np.mean(np.load('input_data/Memory5.npy', allow_pickle=True))
mem6 = np.mean(np.load('input_data/Memory6.npy', allow_pickle=True))

mem2_2 = np.mean(np.load('input_data/Memory2_2.npy', allow_pickle=True))
mem3_2 = np.mean(np.load('input_data/Memory3_2.npy', allow_pickle=True))
mem4_2 = np.mean(np.load('input_data/Memory4_2.npy', allow_pickle=True))
mem5_2 = np.mean(np.load('input_data/Memory5_2.npy', allow_pickle=True))
mem6_2 = np.mean(np.load('input_data/Memory6_2.npy', allow_pickle=True))

mem2_3 = np.mean(np.load('input_data/Memory2_3.npy', allow_pickle=True))
mem3_3 = np.mean(np.load('input_data/Memory3_3.npy', allow_pickle=True))
mem4_3 = np.mean(np.load('input_data/Memory4_3.npy', allow_pickle=True))
mem5_3 = np.mean(np.load('input_data/Memory5_3.npy', allow_pickle=True))
mem6_3 = np.mean(np.load('input_data/Memory6_3.npy', allow_pickle=True))

mem2_4 = np.mean(np.load('input_data/Memory2_4.npy', allow_pickle=True))
mem3_4 = np.mean(np.load('input_data/Memory3_4.npy', allow_pickle=True))
mem4_4 = np.mean(np.load('input_data/Memory4_4.npy', allow_pickle=True))
mem5_4 = np.mean(np.load('input_data/Memory5_4.npy', allow_pickle=True))
mem6_4 = np.mean(np.load('input_data/Memory6_4.npy', allow_pickle=True))
