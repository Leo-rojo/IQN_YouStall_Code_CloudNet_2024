...
cpu3 = np.mean(np.load('../Results/CPU3.npy', allow_pickle=True))
cpu4 = np.mean(np.load('../Results/CPU4.npy', allow_pickle=True))
cpu5 = np.mean(np.load('../Results/CPU5.npy', allow_pickle=True))
cpu6 = np.mean(np.load('../Results/CPU6.npy', allow_pickle=True))

cpu2_2 = np.mean(np.load('../Results/CPU2_2.npy', allow_pickle=True))
cpu3_2 = np.mean(np.load('../Results/CPU3_2.npy', allow_pickle=True))
cpu4_2 = np.mean(np.load('../Results/CPU4_2.npy', allow_pickle=True))
cpu5_2 = np.mean(np.load('../Results/CPU5_2.npy', allow_pickle=True))
cpu6_2 = np.mean(np.load('../Results/CPU6_2.npy', allow_pickle=True))

cpu2_3 = np.mean(np.load('../Results/CPU2_3.npy', allow_pickle=True))
cpu3_3 = np.mean(np.load('../Results/CPU3_3.npy', allow_pickle=True))
cpu4_3 = np.mean(np.load('../Results/CPU4_3.npy', allow_pickle=True))
cpu5_3 = np.mean(np.load('../Results/CPU5_3.npy', allow_pickle=True))
cpu6_3 = np.mean(np.load('../Results/CPU6_3.npy', allow_pickle=True))

cpu2_4 = np.mean(np.load('../Results/CPU2_4.npy', allow_pickle=True))
cpu3_4 = np.mean(np.load('../Results/CPU3_4.npy', allow_pickle=True))
cpu4_4 = np.mean(np.load('../Results/CPU4_4.npy', allow_pickle=True))
cpu5_4 = np.mean(np.load('../Results/CPU5_4.npy', allow_pickle=True))
cpu6_4 = np.mean(np.load('../Results/CPU6_4.npy', allow_pickle=True))

# Load Memory data
mem2 = np.mean(np.load('../Results/Memory2.npy', allow_pickle=True))
mem3 = np.mean(np.load('../Results/Memory3.npy', allow_pickle=True))
mem4 = np.mean(np.load('../Results/Memory4.npy', allow_pickle=True))
mem5 = np.mean(np.load('../Results/Memory5.npy', allow_pickle=True))
mem6 = np.mean(np.load('../Results/Memory6.npy', allow_pickle=True))

mem2_2 = np.mean(np.load('../Results/Memory2_2.npy', allow_pickle=True))
mem3_2 = np.mean(np.load('../Results/Memory3_2.npy', allow_pickle=True))
mem4_2 = np.mean(np.load('../Results/Memory4_2.npy', allow_pickle=True))
mem5_2 = np.mean(np.load('../Results/Memory5_2.npy', allow_pickle=True))
mem6_2 = np.mean(np.load('../Results/Memory6_2.npy', allow_pickle=True))

mem2_3 = np.mean(np.load('../Results/Memory2_3.npy', allow_pickle=True))
mem3_3 = np.mean(np.load('../Results/Memory3_3.npy', allow_pickle=True))
mem4_3 = np.mean(np.load('../Results/Memory4_3.npy', allow_pickle=True))
mem5_3 = np.mean(np.load('../Results/Memory5_3.npy', allow_pickle=True))
mem6_3 = np.mean(np.load('../Results/Memory6_3.npy', allow_pickle=True))

mem2_4 = np.mean(np.load('../Results/Memory2_4.npy', allow_pickle=True))
mem3_4 = np.mean(np.load('../Results/Memory3_4.npy', allow_pickle=True))
mem4_4 = np.mean(np.load('../Results/Memory4_4.npy', allow_pickle=True))
mem5_4 = np.mean(np.load('../Results/Memory5_4.npy', allow_pickle=True))
mem6_4 = np.mean(np.load('../Results/Memory6_4.npy', allow_pickle=True))
