...
if __name__ == "__main__":
    ...
    space_top_selenium = 50 #50 with selenium and chrome, 0 without selenium
    screen_bbox = (100, 170+space_top_selenium, width+100, 853) #I'm removing portion of screen that can interfere with the comparison, like commands/search bar
